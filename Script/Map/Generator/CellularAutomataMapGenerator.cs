...
using Roguelike.Script.Map.Model.Direction;
using Roguelike.Script.Map.Model.Direction.Pattern;
using Roguelike.Script.Map.Model.Grid;

namespace Roguelike.Script.Map.Generator;

public partial class CellularAutomataMapGenerator : Roguelike.Script.Map.Generator.MapGenerator
{
	...
	public override void Begin()
	{
		...
		EmitSignal(Roguelike.Script.Map.Generator.MapGenerator.SignalName.MapGenerated, Grid);
		RunLife();
	}
	...
	private async void RunLife()
	{
		for (int cycle = 0; cycle < LifeCycles; cycle++)
		{
			...
			if (CycleEmissionDelay > 0)
			{
				...
				EmitSignal(Roguelike.Script.Map.Generator.MapGenerator.SignalName.MapUpdated, Grid);
			}
		}

		EmitSignal(Roguelike.Script.Map.Generator.MapGenerator.SignalName.MapFinalized, Grid);
	}
